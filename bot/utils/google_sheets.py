    ...
    def save_order(self, order_data: dict):
        try:
            ...
            row = [
                ...
                order_data.get('price_per_person', 0), # K
                order_data.get('price_for_client', 0), # L
            ...
            orders_sheet.update_cell(last_row, 17, profit_formula)   # Q

            logger.info(f"✅ Заявка #{order_data.get('order_id')} + формулы в P и Q")
